    ...
    class WelcomeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITabBarControllerDelegate {
        ...
        func addDataInArray(){
            arrayTitles = ["Archery", "Badminton", "Dancing", "Baseball", "Basketball", "Bowling", "Boxing", "Parkour", "Car Racing", "Cricket", "Cycling", "Diving", "Pilates", "Extreme Sports", "Fencing", "Field Hockey", "Figure Skater", "Fishing", "Football", "Frisbee", "Golf", "Gymnastics", "Gym", "Handball", "Hiking", "Horseback Riding", "Ice Hockey", "Martial Arts", "Kayaking", "Kick Boxing", "Kite Surfing", "Lacrosse", "Motor Cycling", "Mountain Biking", "SUP", "Paddling", "Paragliding", "Pingpong", "Pole Dancing", "Polo", "Rafting", "Rock Climbing", "Rowing", "Rugby", "Running", "Sailing", "Scuba Diving", "Skateboarding", "Skiing", "Snow Boarding", "Soccer", "Speed Skater", "Surfer", "Swimming", "Tennis", "Slacklining", "Triathlon", "Volleyball", "Water Polo", "Water Sports", "Weightlifter", "Yoga", "Wrestling", "Meditation"]
