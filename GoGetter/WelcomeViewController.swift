    ...
    class WelcomeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITabBarControllerDelegate {
        ...
        func addDataInArray(){
            arrayTitles = ["Archery", "Badminton", "Ballroom Dancing", "Baseball", "Basketball", "Bowling", "Boxing", "Break Dancing", "Car Racing", "Cricket", "Cycling", "Diving", "Exercising Stretching", "Extreme Sports", "Fencing", "Field Hockey", "Figure Skater", "Fishing", "Football", "Frisbee Golf", "Golf", "Gymnastics", "Gym", "Handball", "Hiking", "Horseback Riding", "Ice Hockey", "Kick Boxing", "Kayaking", "Kick", "Kite Surfing", "Lacrosse", "Motor Cycling", "Mountain Biking", "SUP", "Paddling", "Paragliding", "Pingpong", "Pole Dancing", "Polo", "Rafting", "Rock Climbing", "Row Boat", "Rugby", "Running", "Sailing", "Scuba Diving", "Skateboarding", "Skiing", "Snow Boarding", "Soccer", "Speed Skater", "Surfer", "Swimming", "Tennis", "Tight Rope", "Triathlon", "Volleyball", "Water Polo", "Water Sports", "Weightlifter", "Workout", "Wrestling", "Yoga"]
            
            arrayImages =           [#imageLiteral(resourceName: "archeryUnSel"), #imageLiteral(resourceName: "badmintonUnSel"), #imageLiteral(resourceName: "ballroomDancingUnSel"), #imageLiteral(resourceName: "baseballUnSel"), #imageLiteral(resourceName: "basketballUnSel"), #imageLiteral(resourceName: "bowlingUnSel"), #imageLiteral(resourceName: "boxingUnSel"), #imageLiteral(resourceName: "breakDancingUnSel"), #imageLiteral(resourceName: "carRacingUnSel"), #imageLiteral(resourceName: "cricketUnSel"), #imageLiteral(resourceName: "cyclingUnSel"), #imageLiteral(resourceName: "divingUnSel"), #imageLiteral(resourceName: "exercisingStretchingUnSel"), #imageLiteral(resourceName: "extremeSportsUnSel"), #imageLiteral(resourceName: "fencingUnSel"), #imageLiteral(resourceName: "fieldHockeyUnSel"), #imageLiteral(resourceName: "figureSkaterUnSel"), #imageLiteral(resourceName: "fishermanUnSel"), #imageLiteral(resourceName: "footballUnSel"), #imageLiteral(resourceName: "frisbeeUnSel"), #imageLiteral(resourceName: "golfUnSel"), #imageLiteral(resourceName: "gymnastCompetingUnSel"), #imageLiteral(resourceName: "gymUnSel"), #imageLiteral(resourceName: "handballUnSel"), #imageLiteral(resourceName: "hikingUnSel"), #imageLiteral(resourceName: "horseRidingUnSel"), #imageLiteral(resourceName: "iceHockeyUnSel"), #imageLiteral(resourceName: "karateKickUnSel"), #imageLiteral(resourceName: "kayakingUnSel"), #imageLiteral(resourceName: "kickUnSel"), #imageLiteral(resourceName: "kiteSurfUnSel"), #imageLiteral(resourceName: "lacrosseUnSel"), #imageLiteral(resourceName: "motorCyclingUnSel"), #imageLiteral(resourceName: "mountainBikingUnSel"), #imageLiteral(resourceName: "paddleUnSel"), #imageLiteral(resourceName: "paddlingUnSel"), #imageLiteral(resourceName: "paraglidingUnSel"), #imageLiteral(resourceName: "pingPongUnSel"), #imageLiteral(resourceName: "poleDancingUnSel"), #imageLiteral(resourceName: "poloUnSel"), #imageLiteral(resourceName: "raftingUnSel"), #imageLiteral(resourceName: "rockClimbingUnSel"), #imageLiteral(resourceName: "rowBoatUnSel"), #imageLiteral(resourceName: "rugbyUnSel"), #imageLiteral(resourceName: "runningUnSel"), #imageLiteral(resourceName: "sailingUnSel"), #imageLiteral(resourceName: "scubaDivingUnSel"), #imageLiteral(resourceName: "skaterUnSel"), #imageLiteral(resourceName: "skiingUnSel"), #imageLiteral(resourceName: "snowBoardingUnSel"), #imageLiteral(resourceName: "soccerUnSel"), #imageLiteral(resourceName: "speedSkaterUnSel"), #imageLiteral(resourceName: "surferUnSel"), #imageLiteral(resourceName: "swimmingUnSel"), #imageLiteral(resourceName: "tennisUnSel"), #imageLiteral(resourceName: "tightRopeUnSel"), #imageLiteral(resourceName: "triathlonUnSel"), #imageLiteral(resourceName: "volleyballUnSel"), #imageLiteral(resourceName: "waterPoloUnSel"), #imageLiteral(resourceName: "waterSportsUnSel"), #imageLiteral(resourceName: "weightLifterUnSel"), #imageLiteral(resourceName: "workoutUnSel"), #imageLiteral(resourceName: "wrestlingUnSel"), #imageLiteral(resourceName: "yogaUnSel")]
            
            arraySelectedImages =   [#imageLiteral(resourceName: "archerySel"), #imageLiteral(resourceName: "badmintonSel"), #imageLiteral(resourceName: "ballroomDancingSel"), #imageLiteral(resourceName: "baseballSel"), #imageLiteral(resourceName: "basketballSel"), #imageLiteral(resourceName: "bowlingSel"), #imageLiteral(resourceName: "boxingSel"), #imageLiteral(resourceName: "breakDancingSel"), #imageLiteral(resourceName: "carRacingSel"), #imageLiteral(resourceName: "cricketSel"), #imageLiteral(resourceName: "cyclingSel"), #imageLiteral(resourceName: "divingSel"), #imageLiteral(resourceName: "exercisingStretchingSel"), #imageLiteral(resourceName: "extremeSportsSel"), #imageLiteral(resourceName: "fencingSel"), #imageLiteral(resourceName: "fieldHockeySel"), #imageLiteral(resourceName: "figureSkaterSel"), #imageLiteral(resourceName: "fishermanSel"), #imageLiteral(resourceName: "footballSel"), #imageLiteral(resourceName: "frisbeeSel"), #imageLiteral(resourceName: "golfSel"), #imageLiteral(resourceName: "gymnastCompetingSel"), #imageLiteral(resourceName: "gymSel"), #imageLiteral(resourceName: "handballSel"), #imageLiteral(resourceName: "hikingSel"), #imageLiteral(resourceName: "horseRidingSel"), #imageLiteral(resourceName: "iceHockeySel"), #imageLiteral(resourceName: "karateKickSel"), #imageLiteral(resourceName: "kayakingSel"), #imageLiteral(resourceName: "kickSel"), #imageLiteral(resourceName: "kiteSurfSel"), #imageLiteral(resourceName: "lacrosseSel"), #imageLiteral(resourceName: "motorCyclingSel"), #imageLiteral(resourceName: "mountainBikingSel"), #imageLiteral(resourceName: "paddleSel"), #imageLiteral(resourceName: "paddlingSel"), #imageLiteral(resourceName: "paraglidingSel"), #imageLiteral(resourceName: "pingPongSel"), #imageLiteral(resourceName: "poleDancingSel"), #imageLiteral(resourceName: "poloSel"), #imageLiteral(resourceName: "raftingSel"), #imageLiteral(resourceName: "rockClimbingSel"), #imageLiteral(resourceName: "rowBoatSel"), #imageLiteral(resourceName: "rugbySel"), #imageLiteral(resourceName: "runningSel"), #imageLiteral(resourceName: "sailingSel"), #imageLiteral(resourceName: "scubaDivingSel"), #imageLiteral(resourceName: "skaterSel"), #imageLiteral(resourceName: "skiingSel"), #imageLiteral(resourceName: "snowBoardingSel"), #imageLiteral(resourceName: "soccerSel"), #imageLiteral(resourceName: "speedSkaterSel"), #imageLiteral(resourceName: "surferSel"), #imageLiteral(resourceName: "swimmingSel"), #imageLiteral(resourceName: "tennisSel"), #imageLiteral(resourceName: "tightRopeSel"), #imageLiteral(resourceName: "triathlonSel"), #imageLiteral(resourceName: "volleyballSel"), #imageLiteral(resourceName: "waterPoloSel"), #imageLiteral(resourceName: "waterSportsSel"), #imageLiteral(resourceName: "weightLifterSel"), #imageLiteral(resourceName: "workoutSel"), #imageLiteral(resourceName: "wrestlingSel"), #imageLiteral(resourceName: "yogaSel")]
