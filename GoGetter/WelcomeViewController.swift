    ...
    class WelcomeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITabBarControllerDelegate {
        ...
        func addDataInArray(){
            arrayTitles = ["Archery", "Badminton", "Baseball", "Basketball", "Bowling", "Boxing",  "Car Racing", "Cricket", "Cycling", "Dancing",
                           "Diving",  "Extreme Sports", "Fencing", "Field Hockey", "Figure Skater", "Fishing", "Football", "Frisbee","Golf",
                           "Gymnastics", "Gym", "Handball", "Hiking", "Horseback Riding", "Ice Hockey",  "Kayaking", "Kick Boxing","Kite Surfing",
                           "Lacrosse", "Martial Arts", "Meditation", "Motor Cycling", "Mountain Biking",  "Paddling", "Parkour", "Paragliding", "Pilates", "Pingpong", "Pole Dancing","Polo",
                           "Rafting", "Rock Climbing", "Rowing", "Rugby", "Running", "Sailing", "Scuba Diving", "Skateboarding", "Skiing","Slacklining","Snow Boarding",
                           "Soccer", "Speed Skater", "SUP","Surfer", "Swimming", "Tennis",  "Triathlon", "Volleyball", "Water Polo","Water Sports",
                           "Weightlifter", "Wrestling", "Yoga"]
            
            arrayImages =           [#imageLiteral(resourceName: "archeryUnSel"), #imageLiteral(resourceName: "badmintonUnSel"), #imageLiteral(resourceName: "baseballUnSel"), #imageLiteral(resourceName: "basketballUnSel"), #imageLiteral(resourceName: "bowlingUnSel"), #imageLiteral(resourceName: "boxingUnSel"), #imageLiteral(resourceName: "carRacingUnSel"), #imageLiteral(resourceName: "cricketUnSel"), #imageLiteral(resourceName: "cyclingUnSel"),#imageLiteral(resourceName: "ballroomDancingUnSel"),
                                     #imageLiteral(resourceName: "divingUnSel"),  #imageLiteral(resourceName: "extremeSportsUnSel"), #imageLiteral(resourceName: "fencingUnSel"), #imageLiteral(resourceName: "fieldHockeyUnSel"), #imageLiteral(resourceName: "figureSkaterUnSel"), #imageLiteral(resourceName: "fishermanUnSel"), #imageLiteral(resourceName: "footballUnSel"), #imageLiteral(resourceName: "frisbeeUnSel"), #imageLiteral(resourceName: "golfUnSel"),
                                     #imageLiteral(resourceName: "gymnastCompetingUnSel"), #imageLiteral(resourceName: "gymUnSel"), #imageLiteral(resourceName: "handballUnSel"), #imageLiteral(resourceName: "hikingUnSel"), #imageLiteral(resourceName: "horseRidingUnSel"), #imageLiteral(resourceName: "iceHockeyUnSel"),  #imageLiteral(resourceName: "kayakingUnSel"), #imageLiteral(resourceName: "kickUnSel"), #imageLiteral(resourceName: "kiteSurfUnSel"),
                                     #imageLiteral(resourceName: "lacrosseUnSel"), #imageLiteral(resourceName: "karateKickUnSel"),#imageLiteral(resourceName: "yogaUnSel"), #imageLiteral(resourceName: "motorCyclingUnSel"), #imageLiteral(resourceName: "mountainBikingUnSel"),  #imageLiteral(resourceName: "paddlingUnSel"), #imageLiteral(resourceName: "breakDancingUnSel"), #imageLiteral(resourceName: "paraglidingUnSel"), #imageLiteral(resourceName: "exercisingStretchingUnSel"),#imageLiteral(resourceName: "pingPongUnSel"), #imageLiteral(resourceName: "poleDancingUnSel"), #imageLiteral(resourceName: "poloUnSel"),
                                     #imageLiteral(resourceName: "raftingUnSel"), #imageLiteral(resourceName: "rockClimbingUnSel"), #imageLiteral(resourceName: "rowBoatUnSel"), #imageLiteral(resourceName: "rugbyUnSel"), #imageLiteral(resourceName: "runningUnSel"), #imageLiteral(resourceName: "sailingUnSel"), #imageLiteral(resourceName: "scubaDivingUnSel"), #imageLiteral(resourceName: "skaterUnSel"), #imageLiteral(resourceName: "skiingUnSel"), #imageLiteral(resourceName: "tightRopeUnSel"), #imageLiteral(resourceName: "snowBoardingUnSel"),
                                     #imageLiteral(resourceName: "soccerUnSel"), #imageLiteral(resourceName: "speedSkaterUnSel"), #imageLiteral(resourceName: "paddleUnSel"), #imageLiteral(resourceName: "surferUnSel"), #imageLiteral(resourceName: "swimmingUnSel"), #imageLiteral(resourceName: "tennisUnSel"), #imageLiteral(resourceName: "triathlonUnSel"), #imageLiteral(resourceName: "volleyballUnSel"), #imageLiteral(resourceName: "waterPoloUnSel"), #imageLiteral(resourceName: "waterSportsUnSel"),
                                     #imageLiteral(resourceName: "weightLifterUnSel"),  #imageLiteral(resourceName: "wrestlingUnSel"), #imageLiteral(resourceName: "workoutUnSel")]
            
            arraySelectedImages =   arrayImages
